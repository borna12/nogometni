$(window).on('load', function() {
  ...
  $.get('https://docs.google.com/spreadsheets/d/e/2PACX-1vSASto-KTwlBNszOdaLrcWZTqz1FHH-d2qMtJ5hVOlnUDwsh5FxSHwonolGTzIjagBcEszAYepx33SF/pub?gid=1033046795&single=true&output=csv', function(options) {

    $.get('https://docs.google.com/spreadsheets/d/e/2PACX-1vSASto-KTwlBNszOdaLrcWZTqz1FHH-d2qMtJ5hVOlnUDwsh5FxSHwonolGTzIjagBcEszAYepx33SF/pub?output=csv', function(chapters) {
      initMap(
  ...
  */
    ...
    $('#contents').append(" \
      <div id='space-at-the-bottom'> \
        <a href='#top'>  \
          ...
          <small>vrati se na početak</small>  \
        </a> \
      </div> \
    ");
  ...
  function changeAttribution() {
    var attributionHTML = "<a href='https://leafletjs.com/'>Leaflet</a> © <a href='https://www.openstreetmap.org/#map=5/41.211/17.424' target='_blank'>OpenStreetMap</a> u suradnji s © <a href='https://carto.com/' target='_blank'>CARTO";
    var credit = '';
